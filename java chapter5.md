- [javaSE进阶1](#javase进阶1)
  - [关于IDEA工具的快捷键以及一些简单的设置](#关于idea工具的快捷键以及一些简单的设置)
  - [final关键字](#final关键字)
  - [抽象类和接口以及抽象类和接口的区别](#抽象类和接口以及抽象类和接口的区别)
    - [抽象类](#抽象类)
    - [接口](#接口)
      - [接口的基础语法](#接口的基础语法)
      - [接口在开发中的作用](#接口在开发中的作用)
      - [抽类型和接口有什么区别？](#抽类型和接口有什么区别)
  - [类型和类型之间的关系](#类型和类型之间的关系)
    - [is a(继承)、has a(关联)、like a(实现)](#is-a继承has-a关联like-a实现)
  - [源码及API文档概述](#源码及api文档概述)
    - [什么是API](#什么是api)
    - [目前需要知道的几个方法](#目前需要知道的几个方法)
    - [关于Object类中的toString()方法](#关于object类中的tostring方法)
    - [关于Object类中的equals方法](#关于object类中的equals方法)
    - [java语言当中的字符串String有没有重写toString方法，有没有重写equals方法](#java语言当中的字符串string有没有重写tostring方法有没有重写equals方法)
    - [大结论](#大结论)
    - [关于Object类中的finalize()方法。--亡语](#关于object类中的finalize方法--亡语)
    - [关于Object类中的hashCode方法：](#关于object类中的hashcode方法)
  - [匿名内部类](#匿名内部类)

- [常用类](#常用类)
  - [关于java JDK中内置的一个类：java.lang.String](#关于java-jdk中内置的一个类javalangstring)
    - [String字符串的存储原理](#string字符串的存储原理)
    - [面试题：以下程序一共创建了几个对象](#面试题以下程序一共创建了几个对象)
  ...
  - [包装类](#包装类)
    - [装箱与拆箱](#装箱与拆箱)
    - [Integer类的构造方法](#integer类的构造方法)
    - [获取最大值和最小值](#获取最大值和最小值)
    - [自动装箱和自动拆箱](#自动装箱和自动拆箱)
    - [Integer常用方法](#integer常用方法)
    - [总结学过的几个经典异常](#总结学过的几个经典异常)
    - [String int Integer之间互相转换](#string-int-integer之间互相转换)
  - [java对日期的处理](#java对日期的处理)
    - [基本用法](#基本用法)
    - [统计一个方法耗费时间](#统计一个方法耗费时间)
    - [通过毫秒构造Date对象](#通过毫秒构造date对象)
  - [简单总结以下System类的相关属性和方法](#简单总结以下system类的相关属性和方法)
  - [数字类](#数字类)
    - [数字格式化](#数字格式化)
    - [高精度BigDecimal](#高精度bigdecimal)
    - [随机数](#随机数)
  - [枚举类型](#枚举类型)
